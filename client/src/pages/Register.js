...
const Register = () => {
  ...
  const validateVJTIEmail = (_, value) => {
    if (!value || /.+@(\w+\.)+vjti\.ac\.in$/.test(value)) {
      return Promise.resolve();
    }
    return Promise.reject("Please enter a valid VJTI email address");
  };
